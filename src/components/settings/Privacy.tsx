...
const Privacy: React.FC<PrivacyProps> = ({ handleView }) => {
  return (
    <div className=" md:h-screen flex flex-col w-full gap-2">
      ...
      <div className="md:h-[80vh] text-justify md:overflow-auto justify-start items-start  w-fullflex flex-col gap-2 text-xs">
        <p>
